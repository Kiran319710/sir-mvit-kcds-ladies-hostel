<div class="header">
		<div class="container">
			<div class="header-grids">
				<div class="logo">
					<h1><img src="images/logo.jpg" style="margin-right:10px;"><a  href="index.php"><span>Sir MVIT</span> <br />(KCDS Ladies Hostel)</a></h1>
				</div>
				<!--navbar-header-->
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li><a href="hostel-fees.php"> Fees</a></li>
						<li><a href="transport.php">Transport Facility</a></li>
						<li><a href="campus.php">Campus Area</a></li>
				...
				<div class="dropdown-grids">
						<div id="loginContainer"><a href="#" id="loginButton"><span>Login</span></a>
							<div id="loginBox">                
								<form id="loginForm" action="login-panel.php">
